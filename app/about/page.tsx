...
export default async function AboutPage() {
  let chairs: CommitteeChair[] = []
  let advisors: FacultyAdvisor[] = []

  try { chairs = await getCommitteeChairs() } catch (error) { console.error('Failed to fetch committee chairs:', error) }
  try { advisors = await getFacultyAdvisors() } catch (error) { console.error('Failed to fetch faculty advisors:', error) }
