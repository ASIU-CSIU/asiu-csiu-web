    ...
    <LayoutWrapper>
      ...
      <section className="bg-gradient-to-r from-blue-50 to-green-50 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-heading text-4xl md:text-5xl font-bold text-gray-900 mb-6">Our Team</h1>
          <p className="text-xl text-gray-600 leading-relaxed">
            Meet the dedicated students and faculty who lead our advocacy efforts and drive meaningful change in science
            policy.
          </p>
        </div>
      </section>
